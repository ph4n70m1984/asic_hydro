...
| Периферия / Назначение | Оборудование / Интерфейс | Пины ESP32 | Ссылка / Описание |
| :--- | :--- | :--- | :--- |
| **Управляющая плата** | Eletechsup ES32D26 | — | [AliExpress](https://ali.click/ylbag13) (ESP32, 8 реле, RS485, DAC) |
| **Реле CH1..CH8** | `74HC595` (Сдвиговый регистр) | `SER`: 12, `OE`: 13, `RCLK`: 23, `SRCLK`: 22 | Управление 8 силовыми каналами |
| **Входы IN1..IN8** | `74HC165` (Сдвиговый регистр) | `QH`: 15, `CLK`: 2, `SH`: 0 | Выключатели с фиксацией ("сухой контакт") |
| **Регулирующий клапан** | Tsai Fan TFM15-S2-C 1/2'' | `DAC2`: GPIO26 | [AliExpress](https://ali.click/5pbag19) (Управление 4–20 мА) |
| **Датчик давления** | Xuyang Starts Electricity G1/2'' | `TX0`: IO1, `RX0`: IO3, `DIR`: IO21 | [AliExpress](https://ali.click/y0cag1q) (RS485 Modbus RTU) |
...
* **CH7:** Дополнительное реле (`asic/relay7`) / Тумблер `IN7`.
* **CH8:** Реле аварии / Доп. оборудование (`asic/relay8`) / Тумблер `IN8`.
---
